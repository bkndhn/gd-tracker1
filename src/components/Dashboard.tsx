        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b">
          <div className="w-full sm:w-auto overflow-x-auto no-scrollbar pb-0.5">
            <TabsList className="flex w-full sm:w-auto items-center p-1 bg-muted/60 border rounded-xl gap-1 h-auto no-scrollbar">
              ...
              >
                <BarChart3 className="h-4 w-4 shrink-0 text-indigo-500 group-data-[state=active]:text-white transition-colors" />
                <span className="font-semibold sm:hidden">Visits</span>
                <span className="font-semibold hidden sm:inline">Visit Analytics</span>
              </TabsTrigger>
              <TabsTrigger
                value="warehouse"
              ...
              >
                ...
                <span className="font-semibold sm:hidden">Stock</span>
                <span className="font-semibold hidden sm:inline">Requirements Status</span>
              </TabsTrigger>
              <TabsTrigger
                value="predictive"
