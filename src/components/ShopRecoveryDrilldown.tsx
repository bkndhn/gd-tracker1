          ...
          <Tabs defaultValue="entries" className="space-y-4">
            <div className="overflow-x-auto no-scrollbar pb-1 scroll-px-2">
              <TabsList className="w-full inline-flex lg:grid lg:grid-cols-5 h-auto p-1.5 gap-1.5 bg-muted/60 border rounded-xl min-w-max lg:min-w-0">
                <TabsTrigger
                  value="entries"
                  className="group flex items-center justify-center gap-2 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg whitespace-nowrap shrink-0 transition-all data-[state=active]:bg-gradient-to-r data-[state=active]:from-emerald-600 data-[state=active]:to-teal-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-emerald-500/20 data-[state=inactive]:text-muted-foreground data-[state=inactive]:hover:text-foreground data-[state=inactive]:hover:bg-background/50"
                >
                  <ListFilter className="h-4 w-4 text-emerald-500 group-data-[state=active]:text-white transition-colors shrink-0" />
                  <span>Recovered</span>
                  <span className="ml-0.5 text-[10px] px-1.5 py-0.2 rounded-full bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 group-data-[state=active]:bg-white/25 group-data-[state=active]:text-white font-bold shrink-0">
                    {converted.length}
                  </span>
                </TabsTrigger>
                <TabsTrigger
                  value="charts"
                  className="group flex items-center justify-center gap-2 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg whitespace-nowrap shrink-0 transition-all data-[state=active]:bg-gradient-to-r data-[state=active]:from-indigo-600 data-[state=active]:to-blue-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-indigo-500/20 data-[state=inactive]:text-muted-foreground data-[state=inactive]:hover:text-foreground data-[state=inactive]:hover:bg-background/50"
                >
                ...
                <TabsTrigger
                  value="staff"
                  className="group flex items-center justify-center gap-2 py-2 px-3 text-xs sm:text-sm font-medium rounded-lg whitespace-nowrap shrink-0 transition-all data-[state=active]:bg-gradient-to-r data-[state=active]:from-cyan-600 data-[state=active]:to-teal-600 data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-cyan-500/20 data-[state=inactive]:text-muted-foreground data-[state=inactive]:hover:text-foreground data-[state=inactive]:hover:bg-background/50"
                >
