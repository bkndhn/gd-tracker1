  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "inset-x-0 bottom-0 top-auto w-full max-h-[92dvh] overflow-y-auto rounded-t-[28px] border-x-0 border-b-0 p-5 pb-[calc(1.25rem+env(safe-area-inset-bottom,0px))] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom " +
      ...
      {...props}
    >
      {/* Material bottom-sheet drag handle (mobile only) */}
      <div className="sm:hidden mx-auto -mt-1 mb-1 h-1 w-10 shrink-0 rounded-full bg-muted-foreground/30" aria-hidden />
      {children}
